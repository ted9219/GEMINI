...
비교 대상이 되는 테이블 레코드 수의 총합을 기준으로 테이블 별 레코드 분율
...
의료 서비스를 제공하는 장소의 종류 수 및 Null 값의 분율
...
Visit Occurrence 테이블에서 환자가 차지하는 분율
