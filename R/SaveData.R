...
persontbl_list <- list(persontbl_record, persontbl_person_ratio, persontbl_gender, persontbl_min_age,persontbl_max_age,persontbl_race
                    ,persontbl_ethnicity,persontbl_location,persontbl_provider,persontbl_care_site)
persontbl_name_list <- c("persontbl_record","persontbl_person_ratio","persontbl_gender", "persontbl_min_age", "persontbl_max_age",
                         "persontbl_race","persontbl_ethnicity", "persontbl_location", "persontbl_provider","persontbl_care_site")
#Making path, Save Data
# saveRDS(object = persontbl_list, file = "Standard RDS/test.rds")
# rds_temp <- readRDS(file = "Standard RDS/test.rds")
# rds_temp[[1]]
...
visittbl_list <- list(visittbl_record, visittbl_person_ratio, visittbl_visit_concept, visittbl_start,visittbl_end,visittbl_diff_date
...
str(visittbl_record)
visittbl_name_list <- list("visittbl_record", "visittbl_person_ratio", "visittbl_visit_concept", "visittbl_start","visittbl_end",
...
conditiontbl_list <- list(conditiontbl_record, conditiontbl_person_ratio, conditiontbl_diff_date,conditiontbl_start,conditiontbl_end,
                          conditiontbl_type_concept,conditiontbl_stop,conditiontbl_visit_occurrence,conditiontbl_visit_detail)
conditiontbl_name_list <- list("conditiontbl_record", "conditiontbl_person_ratio", "conditiontbl_diff_date","conditiontbl_start",
...
drug_exptbl_list <- list(drug_exptbl_record, drug_exptbl_person_ratio, drug_exptbl_diff_date,drug_exptbl_start,drug_exptbl_end,
                         drug_exptbl_type_concept,drug_exptbl_stop,drug_exptbl_route,drug_exptbl_visit_occurrence)
drug_exptbl_name_list <- list("drug_exptbl_record", "drug_exptbl_person_ratio", "drug_exptbl_diff_date","drug_exptbl_start","drug_exptbl_end",
                              "drug_exptbl_type_concept","drug_exptbl_stop","drug_exptbl_route","drug_exptbl_visit_occurrence")
...
drug_eratbl_list <- list(drug_eratbl_record, drug_eratbl_person_ratio, drug_eratbl_diff_date, drug_eratbl_start,drug_eratbl_end,
                         drug_eratbl_exp_count,drug_eratbl_gap_days)
drug_eratbl_name_list <- list("drug_eratbl_record", "drug_eratbl_person_ratio", "drug_eratbl_diff_date","drug_eratbl_start","drug_eratbl_end",
                              "drug_eratbl_exp_count","drug_eratbl_gap_days")
