...
################################################################################
tryCatch({drug_eratbl_diff_date <- get_diff_year("drug_era","drug_era_start_date","drug_era_end_date")
},error=function(e){
...
#
################################################################################
tryCatch({drug_eratbl_exp_count <- get_ratio("drug_era","drug_exposure_count")
},error=function(e){
