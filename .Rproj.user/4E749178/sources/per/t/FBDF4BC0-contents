...
################################################################################
tryCatch({drug_exptbl_diff_date <- get_diff_year("drug_exposure","drug_exposure_start_date","drug_exposure_end_date")
},error=function(e){
...
################################################################################
tryCatch({drug_exptbl_type_concept <- get_ratio("drug_exposure","drug_type_concept_id")
},error=function(e){
...
drug_exptbl_stop<-DatabaseConnector::querySql(connection,sql)
colnames(drug_exptbl_stop)<-SqlRender::snakeCaseToCamelCase(colnames(drug_exptbl_stop))
},error=function(e){
...
################################################################################
tryCatch({drug_exptbl_route <- get_ratio("drug_exposure","route_concept_id")
},error=function(e){
...
################################################################################
tryCatch({drug_exptbl_visit_occurrence <- get_compared_ratio("drug_exposure","visit_occurrence_id","drug_exposure_id")
},error=function(e){
...
################################################################################
tryCatch({drug_exptbl_visit_detail <- get_compared_ratio("drug_exposure","visit_detail_id","drug_exposure_id")
},error=function(e){
