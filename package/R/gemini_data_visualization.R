...
#' This function allows Pie3D can draw by changing 0 value to little value 
...
#' This function appends 0 to data frame for drawing gender graph 
#' @param attName Attribute name in schema table.
#' @keywords transform
#' @export
...
#' This function provides labeling.
...
#' This function changes NA data to 'NA' string data.
#' @param value text for label
#' @keywords label
#' @export
...
#' This function provides if occur no data error, print "No data" to show user
#' @keywords draw_error
#' @export
afterError <- function() {
...
#' This function set graph x_axis
#' @param std_value standard RDS value that has time data
#' @param tar_value target RDS value that has time data
#' @keywords label
#' @export
...
#' This function set y_axis which got more big value
#' @param std_value standard RDS value that has time data
#' @param tar_value target RDS value that has time data
#' @keywords label
#' @export
...
#' This function sets the label of the bar graph by selecting the appropriate location 
#' @param std_att standard RDS value
#' @param tar_att target RDS value
#' @param unit add unit
#' @param dp criteria of label position
#' @keywords label
#' @export
...
#' This function draws grid line on line graph
#' @param std_value standard RDS value
#' @param tar_value target RDS value
#' @keywords label
#' @export
...
#' This function creates Pie chart image which use attribute_name
#' @param std_value standard RDS value
#' @param tar_value target RDS value
#' @param path location about saving image file
#' @keywords draw
#' @export
...
#' This function creates pie chart image which two attribute for comparing
#' @param std_value standard RDS value
#' @param tar_value target RDS value
#' @param path location about saving image file
#' @keywords draw
...
#' This function creates pie chart image which uses table infomation
#' @param std_value standard RDS value
#' @param tar_value target RDS value
...
#' This function creates line graph image which based on start date
#' @param std_value standard RDS value
#' @param tar_value target RDS value
#' @param text title name by typing
#' @param path location about saving image file
#' @keywords draw
#' @export
...
#' This function creates line graph image which based on end date
#' @param std_value standard RDS value
#' @param tar_value target RDS value
#' @param na_value NA data. It can't visualize on line graph
#' @param over_value 2999 data.This data makes line graph look weird.
#' @param title title name by typing
#' @param path location about saving image file
#' @keywords draw
#' @export
...
#' @param na_value NA data. It can't visualize on line graph
#' @param over_value 2999 data.This data makes line graph look weird.
#' @param title image title by typing
#' @param path location about saving image file
#' @keywords draw
#' @export
...
#' This function draws bar chart with fraction
#' @param std_value standard RDS value
#' @param tar_value target RDS value
#' @param path location about saving image file
#' @keywords draw
...
#' This function draws bar chart by counts
#' @param std_value standard RDS value
#' @param tar_value target RDS value
#' @param text image title by typing
#' @param path location about saving image file
#' @keywords draw
#' @export
...
#' This function draws bar chart by Comparing two attributes
#' @param std_value standard RDS value
#' @param tar_value target RDS value
#' @param text image title by typing
#' @param path location about saving image file
